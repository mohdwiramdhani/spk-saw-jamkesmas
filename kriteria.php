...
if (isset($_POST['simpan'])) {
  ...
  if (($id_kriteria=="")or($nama_kriteria=="")) {
    echo "<script>
...
<div class="col-lg-12">
<section class="panel">
  <header class="panel-heading"><b><h4 style="line-height: 2;text-align: center;">Tambah Alternatif</h4></b>
  </header>
          ...
          <form class="form-validate form-horizontal " id="register_form" method="post" action="">
            <div class="add">
                <div class="form-group">
                  ...
                  <div class="col-lg-2">
                      <input class=" form-control" name="id_alternatif" type="text" />
                  </div><br><br>
